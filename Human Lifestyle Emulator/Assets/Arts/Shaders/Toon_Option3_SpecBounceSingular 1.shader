Shader "Custom/Toon_Option3_SpecBounceSingular" 
{
	Properties
	{
		...
		_SpecThresh("Specular Pow, Div", Vector) = (2, 1,0,0)
	...
	{		
		Pass
		{
			...
			float4 frag(vertexOutput i) : COLOR
			{
				...
				specBounce = saturate(pow(specBounce, _SpecThresh.x)*_SpecThresh.y);
				...
				float3 bounceCol = viewRamp * specBounce;
